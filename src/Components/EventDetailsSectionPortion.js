...
function EventDetailsSectionPortion() {
  return (
    <>
        ...
        <div className="col-lg-8">
          <div className="event-detail-left">
            <div className="event-img mb-4">
              <img src="images/group/4.jpg" alt="event-image" className="w-100 rounded"/>
            </div>
                ...
                <div className="row gy-3">
                  <div className="col-lg-4 col-md-4">
                    <div className="speaker-box  position-relative overflow-hidden text-white">
                      <img className="speaker-image rounded w-100" src="images/speakers/1.jpg" alt="speaker-image"/>
                      <div className="box-content position-absolute bottom-0 z-1">
                        <h6 className="speaker-title d-block text-white pb-1"><a href="speaker_detail.html">GERARDO AMBROSE</a>
                        </h6>
                        <span className="speaker-post d-block pb-2">Marketing Expert</span>
                        <ul className="social-link pb-2 ps-0">
                          <li className="d-inline-block"><a href="#" className="rounded d-block me-1"><i
                  ...
                  <div className="col-lg-4 col-md-4">
                    <div className="speaker-box position-relative overflow-hidden">
                      <img className="speaker-image rounded w-100" src="images/speakers/2.jpg" alt="speaker-image"/>
                      <div className="box-content position-absolute bottom-0 z-1">
                        <h6 className="speaker-title d-block text-white pb-1"><a href="speaker_detail.html">GERARDO AMBROSE</a>
                        </h6>
                        <span className="speaker-post d-block pb-2">Marketing Expert</span>
                        <ul className="social-link pb-2 ps-0 position-relative">
                          <li className="d-inline-block"><a href="#" className="rounded d-block me-1"><i
                                className="fa fa-facebook"></i></a></li>
                          <li className="d-inline-block"><a href="#" className="rounded d-block me-1"><i
                                className="fa fa-twitter"></i></a></li>
                  ...
                  <div className="col-lg-4 col-md-4">
                    <div className="speaker-box position-relative overflow-hidden">
                      <img className="speaker-image rounded w-100" src="images/speakers/4.jpg" alt="speaker-image"/>
                      <div className="box-content position-absolute bottom-0 z-1">
                        <h6 className="speaker-title d-block text-white pb-1"><a href="speaker_detail.html">GERARDO AMBROSE</a>
                        </h6>
                        <span className="speaker-post d-block pb-2">Marketing Expert</span>
        ...
        <div className="col-lg-4">
          <div className="event-detail-right text-center">
            <div className="event-ticket-price d-md-flex align-items-center justify-content-center justify-content-lg-start mb-5">
              <a className="btn me-4 m-sm-0" href="book-now.html">Buy Ticket</a>
              ...
              <div className="organizer-list">
                <div className="organizer d-md-flex text-md-start pb-4 mb-4 border-dashed-bottom-2">
                  <div className="organizer-bio-image ">
                    <a href="speaker_detail.html"><img src="images/team/1.jpg" alt="team-image" className="me-2 rounded-circle m-sm-0"/></a>
                  </div> 
                  <div className="organizer-bio-info"> 
                    <p className="mt-1 mb-0 fw-semibold black text-uppercase"><a href="speaker_detail.html" className="black">Rickey Malone</a></p>
                    <small>Speaker</small>
                  </div> 
                </div>
                <div className="organizer d-md-flex text-md-start border-0 pb-1">
                  <div className="organizer-bio-image ">
                    <a href="speaker_detail.html"><img src="images/team/2.jpg" alt="team-image" className="me-2 rounded-circle m-sm-0"/></a>
                  </div> 
                  <div className="organizer-bio-info"> 
                    <p className="mt-1 mb-0 fw-semibold black text-uppercase"><a href="speaker_detail.html" className="black">JESUS HOLLAND</a></p> 
            ...
            <div className="contact-us-outer position-relative rounded">
              ...
              <div className="contact-us  px-6 py-8 position-relative text-white">
                ...
                <div className="contact-btn">
                  <a className="btn btn3" href="contact.html">Contact Us<i className="fa fa-long-arrow-right ms-4"></i></a>
                </div>
              </div>
            </div>  
          </div>
...
export default EventDetailsSectionPortion