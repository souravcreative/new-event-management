                ...
                <div className="row gx-md-5">
                    ...
                    <div className="schedule-list-left">
                      <div className=" schedule-list-box bg-lightgrey   border border-white border-2 rounded px-6 py-4 mb-4">
                        <div className="schedule-box-title">
                          <h5 className="mb-2"><a href="event-detail.html" className="black">REGISTRATION & br/EAKFAST</a></h5>
                        </div> 
                        <div className="schedule-box-info">
                          ...
                          <div className="schedule-box-bio d-md-flex">
                            <div className="schedule-bio-image ">
                              <img src="images/team/2.jpg" alt="team-image" className="me-2 rounded-circle"/>
                            </div> 
                            <div className="schedule-bio-info"> 
                              <p className="mt-1 mb-0"><a href="speaker_detail.html" className="pink">JESUS HOLLAND</a></p>
                      ...
                      <div className=" schedule-list-box bg-white border-lightgrey border border-2 rounded px-6 py-4 mb-4">
                        <div className="schedule-box-title">
                          <h5 className="mb-2"><a href="event-detail.html" className="black">Business Management Info</a></h5>
                        </div> 
                        <div className="schedule-box-info">
                          <p className="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec ullamcorper mattis, pulvinar dapibus leo.</small></p>
                          <ul className="mb-2 p-0">
                        ...
                        <div className="schedule-box-bio d-md-flex">
                          <div className="schedule-bio-image">
                            <img src="images/team/3.jpg" alt="team-image" className="me-2 rounded-circle"/>
                          </div> 
                          <div className="schedule-bio-info"> 
                            <p className="mt-1 mb-0 pink"><a href="speaker_detail.html" className="pink">NELSON KETY</a></p>
                            <small>Host & Speaker</small>
                        </div>
                      </div>    
                    </div>
                 ...
                 <div className="col-lg-6 col-md-6">
                    <div className="schedule-list-left">
                      <div className=" schedule-list-box bg-white border-lightgrey border border-2 rounded px-6 py-4 mb-4">
                        <div className="schedule-box-title">
                          <h5 className="mb-2"><a href="event-detail.html" className="black">Workshop: Culture & Creativity</a></h5>
                        </div> 
                        <div className="schedule-box-info">
                          <p className="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec ullamcorper mattis, pulvinar dapibus leo.</small></p>
                          <ul className="mb-2 p-0">
                        ...
                        <div className="schedule-box-bio d-md-flex">
                          <div className="schedule-bio-image">
                            <img src="images/team/1.jpg" alt="team-image" className="me-2 rounded-circle"/>
                          </div> 
                          <div className="schedule-bio-info"> 
                            <p className="mt-1 mb-0 pink"><a href="speaker_detail.html" className="pink">NELSON KETY</a></p>
                            <small>Host & Speaker</small>
                      ...
                      <div className=" schedule-list-box bg-lightgrey   border border-white border-2 rounded px-6 py-4">
                        <div className="schedule-box-title">
                          <h5 className="mb-2"><a href="event-detail.html" className="black">Exploration & Approch</a></h5>
                        </div> 
                        <div className="schedule-box-info">
                            <p className="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec ullamcorper mattis, pulvinar dapibus leo.</small></p>
                            <ul className="mb-2 p-0">
                          ...
                          <div className="schedule-box-bio d-md-flex">
                            ...
                            <div className="schedule-bio-info"> 
                              <p className="mt-1 mb-0 pink"> <a href="speaker_detail.html" className="pink">JESUS HOLLAND</a></p>
                              <small>Host & Speaker</small>
                            </div>  
                        </div>  
                      </div>
  ...
  <div className="container">
    <div className="schedule-2-inner w-lg-60 m-auto text-center text-md-start">
      ...
      <div className="schedule-list">
        <div className=" schedule-list-box bg-white border-lightgrey border border-2 rounded px-6 py-4 mb-4">
          <div className="schedule-box-title">
            <h5 className="mb-2"><a href="event-detail.html" className="black">SPEED: MARKETING MASTER!</a></h5>
          </div> 
          <div className="schedule-box-info">
            <p className="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec ullamcorper mattis, pulvinar dapibus leo.</small></p>
            <ul className="mb-2 p-0">
        ...
        <div className=" schedule-list-box bg-lightgrey   border border-white border-2 rounded px-6 py-4 mb-4">
          <div className="schedule-box-title">
            <h5 className="mb-2"><a href="event-detail.html" className="black">Digital Marketing Theory</a></h5>
          </div> 
          <div className="schedule-box-info">
              <p className="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec ullamcorper mattis, pulvinar dapibus leo.</small></p>
              <ul className="mb-2 p-0">
        ...
        <div className=" schedule-list-box bg-white border-lightgrey border border-2 rounded px-6 py-4 ">
          <div className="schedule-box-title">
            <h5 className="mb-2"><a href="event-detail.html" className="black">Global Inovations in Medias</a></h5>
          </div> 
          <div className="schedule-box-info">
            <p className="mb-2"><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, luctus nec ullamcorper mattis, pulvinar dapibus leo.</small></p>
            <ul className="mb-2 p-0">
